        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfAccountings = table.Column<int>(type: "int", nullable: false),
                    AccountedCoins = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersProgressInfo", x => x.UserID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BigFields", x => x.ID);
                    table.ForeignKey(
                        name: "FK_BigFields_Worlds_WorldID",
                        column: x => x.WorldID,
